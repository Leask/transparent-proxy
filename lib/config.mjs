import { STRINGS, SLASH, SLASH_REGEXP, HTTP, HTTPS, HTTP_PORT, HTTPS_PORT } from './constants.mjs';
import { isValidASCII } from './utilitas.mjs';
 ...
 */
export default (proxyToUse, upstreamHost) => {
